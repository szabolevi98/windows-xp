...
async function enterDesktop(){
 ...
 else if(state.showWelcome)notify('Üdv a Windows XP-ben!', 'Az ikonokat dupla kattintással nyithatod meg. Kezdj a Start menüvel, és fedezd fel a régi kedvenceket! Az F11 billentyűvel teljes képernyőre válthatsz — úgy az igazi.');
}
