...
window.XP = (() => {
  ...
  function applySettings(){document.body.dataset.theme=state.theme;$('#desktop').style.backgroundImage=state.wallpaper==='none'?'none':`url("${wallpaperPath(state.wallpaper)}")`;}
  function sound(name){
